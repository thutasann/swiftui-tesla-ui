...
struct LocationView: View {
    ...
    var body: some View {
        ZStack{
            ...
            LinearGradient(gradient: Gradient(colors: [Color("DrakGray"), Color.clear]), startPoint: .top, endPoint: .bottom)
            ...
            VStack {
                HStack{
                    ...
                    Spacer()
                    Button(action: {}){
                        HeaderButton(icon: "speaker.wave.3.fill")
                    }
                }
                .padding()
                Spacer()
